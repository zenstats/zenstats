...
func (evtq *EmailVerificationTokenQuery) QueryUser() *UserQuery {
...
func (evtq *EmailVerificationTokenQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (evtq *EmailVerificationTokenQuery) FirstIDX(ctx context.Context) int64 {
...
func (evtq *EmailVerificationTokenQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (evtq *EmailVerificationTokenQuery) OnlyIDX(ctx context.Context) int64 {
...
func (evtq *EmailVerificationTokenQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (evtq *EmailVerificationTokenQuery) IDsX(ctx context.Context) []int64 {
...
func (evtq *EmailVerificationTokenQuery) WithUser(opts ...func(*UserQuery)) *EmailVerificationTokenQuery {
	query := (&UserClient{config: evtq.config}).Query()
...
//		GroupBy(emailverificationtoken.FieldUserID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.EmailVerificationToken.Query().
//		Select(emailverificationtoken.FieldUserID).
//		Scan(ctx, &v)
...
func (evtq *EmailVerificationTokenQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*EmailVerificationToken, error) {
	...
	if query := evtq.withUser; query != nil {
		if err := evtq.loadUser(ctx, query, nodes, nil,
...
func (evtq *EmailVerificationTokenQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*EmailVerificationToken, init func(*EmailVerificationToken), assign func(*EmailVerificationToken, *User)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*EmailVerificationToken)
	for i := range nodes {
		fk := nodes[i].UserID
...
func (evtq *EmailVerificationTokenQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(emailverificationtoken.Table, emailverificationtoken.Columns, sqlgraph.NewFieldSpec(emailverificationtoken.FieldID, field.TypeInt64))
	_spec.From = evtq.sql
