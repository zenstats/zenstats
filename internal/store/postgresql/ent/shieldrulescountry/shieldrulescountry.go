...
const (
	// Label holds the string label denoting the shieldrulescountry type in the database.
	Label = "shield_rules_country"
	...
	EdgeSite = "site"
	// Table holds the table name of the shieldrulescountry in the database.
	Table = "shield_rules_countries"
	// SiteTable is the table that holds the site relation/edge.
	SiteTable = "shield_rules_countries"
...
// Columns holds all SQL columns for shieldrulescountry fields.
var Columns = []string{
	FieldID,
	FieldSiteID,
	FieldCountryCode,
...
// OrderOption defines the ordering options for the ShieldRulesCountry queries.
